...
//             setDataType(type);
//             if (type === 'users') {
//                 setFilteredUsers(data); // Initialize filteredUsers with the fetched users
//             } else if (type === 'clients') {
//                 setFilteredClients(data); // Initialize filteredClients with the fetched clients
//             } else if (type === 'projects') {
//                 setFilteredProjects(data); // Initialize filteredProjects with the fetched projects
//             }
//         } catch (error) {
//             console.error(`Error fetching ${type}:`, error);
//         }
