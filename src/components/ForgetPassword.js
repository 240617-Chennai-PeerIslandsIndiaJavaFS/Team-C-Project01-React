    ...
    return (
        <div id="forget-container">
            ...
            <form id="forget-password-form" onSubmit={handleForgetPassword}>
                ...
                <div id="forget-form-group-email">
                ...
                <div id="forget-form-group-new-password">
                ...
                <div id="forget-form-group-confirm-password">
                ...
                <button type="submit" id="forget-button">Reset Password</button>
            </form>
            {message && <p id="forget-message">{message}</p>}
        </div>
    );
};
